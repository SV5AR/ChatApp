...
const ConversationActionsMenu = ({
  ...
  useEffect(() => {
    // Ensure position calculation happens after mount
  ...
  // Place menu 6px below the button, clamped to viewport
  ...
  const menuJSX = (
    <div
      className="app-menu dropdown-enter"
      style={{
        position: "fixed",
        left,
        top,
  ...
  // Render menu at document body level to escape all parent stacking contexts
