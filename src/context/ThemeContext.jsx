...
function applyMaterial(baseTheme, materialName) {
  ...
  if (materialName === "glass") {
    ...
    return {
      ...baseTheme,
      material: "glass",
      surface: isDark ? "rgba(18, 24, 36, 0.78)" : "rgba(255, 255, 255, 0.86)",
      surface2: isDark ? "rgba(28, 34, 50, 0.72)" : "rgba(255, 255, 255, 0.78)",
      surface3: isDark ? "rgba(36, 44, 62, 0.66)" : "rgba(246, 249, 255, 0.74)",
      surfaceHover: isDark ? "rgba(36, 44, 62, 0.82)" : "rgba(250, 253, 255, 0.9)",
      inputBg: isDark ? "rgba(24, 30, 46, 0.7)" : "rgba(255, 255, 255, 0.8)",
      border: isDark ? "rgba(255,255,255,0.24)" : "rgba(10,20,40,0.16)",
      inputBorder: isDark ? "rgba(255,255,255,0.26)" : "rgba(20,36,64,0.2)",
      headerBg: isDark ? "rgba(20, 26, 42, 0.62)" : "rgba(255,255,255,0.6)",
      headerBtn: isDark ? "rgba(34, 42, 58, 0.58)" : "rgba(240,245,255,0.58)",
      cardShadow: isDark
        ? "0 14px 36px rgba(0,0,0,0.42)"
        : "0 12px 30px rgba(20,30,50,0.14)",
      materialFx: {
        ...
        focusHalo: isDark ? "rgba(165,205,255,0.45)" : "rgba(68,125,255,0.34)",
        focusWidth: "2px",
  ...
  if (materialName === "neumorphism") {
    ...
    return {
      ...
      surface: isDark ? "#2A2E39" : "#ECEEF3",
      surface2: isDark ? "#323745" : "#E4E7EE",
      surface3: isDark ? "#3A4050" : "#DDE1EA",
      surfaceHover: isDark ? "#343A4A" : "#E8EBF2",
      inputBg: isDark ? "#323745" : "#F0F2F7",
      border: isDark ? "#3E4455" : "#D6DAE4",
      inputBorder: isDark ? "#4B546A" : "#CDD3E0",
      headerBg: isDark ? "#2A2E39" : "#ECEEF3",
      headerBtn: isDark ? "#323745" : "#E4E7EE",
      cardShadow: isDark
      ...
      materialFx: {
        ...
        focusHalo: isDark ? "rgba(132,152,188,0.38)" : "rgba(86,104,140,0.26)",
        focusWidth: "1.5px",
  ...
  if (materialName === "m3") {
    ...
    return {
      ...baseTheme,
      material: "m3",
      surface: isDark ? "#1F1C24" : "#FFFBFE",
      surface2: isDark ? "#28242D" : "#F4EFF4",
      surface3: isDark ? "#312C37" : "#ECE6ED",
      surfaceHover: isDark ? "#3A3442" : "#E8E1E9",
      border: isDark ? "#4A4453" : "#CAC4D0",
      inputBg: isDark ? "#28242D" : "#F4EFF4",
      inputBorder: isDark ? "#7A7385" : "#7A757F",
      headerBg: isDark ? "#1C1B1F" : "#FFFBFE",
      headerBtn: isDark ? "#312C37" : "#ECE6ED",
      cardShadow: isDark
      ...
      materialFx: {
        ...
        focusHalo: isDark ? "rgba(214,190,255,0.36)" : "rgba(103,80,164,0.22)",
        focusWidth: "2px",
...
export const ThemeProvider = ({ children }) => {
  ...
  const setTheme = (n) => {
    ...
    if (next === "aureate" && materialName === "glass") {
      setMaterialName("m3");
      sessionStorage.setItem("chatapp_material", "m3");
    }
  };
  const setMaterial = (n) => {
    setMaterialName(n);
