...
export const ThemeProvider = ({ children }) => {
  ...
  const [shapeName, setShapeName] = useState(() => {
    const saved = sessionStorage.getItem("chatapp_shape") || "rounded";
    return SHAPE_STYLES[saved] ? saved : "rounded";
  });
  ...
  useEffect(() => {
    ...
    if (shapeName === "sharp") {
      root.style.setProperty("--app-radius-xs", "2px");
      root.style.setProperty("--app-radius-sm", "4px");
      root.style.setProperty("--app-radius-md", "6px");
      root.style.setProperty("--app-radius-lg", "8px");
      root.style.setProperty("--app-radius-xl", "10px");
      root.style.setProperty("--app-focus-radius", "4px");
    } else if (shapeName === "soft") {
      root.style.setProperty("--app-radius-xs", "10px");
      root.style.setProperty("--app-radius-sm", "12px");
      root.style.setProperty("--app-radius-md", "16px");
      root.style.setProperty("--app-radius-lg", "22px");
      root.style.setProperty("--app-radius-xl", "28px");
      ...
      root.style.setProperty("--app-radius-lg", "14px");
      root.style.setProperty("--app-radius-xl", "18px");
